...
<div style="margin-left: 15%">
	...
	<div class="w3-container w3-deep-orange">
		<h2>Please send the donation
			of <% out.print(currentRequest.getQuantityRequested()); %> <% out.print(currentRequest.getProductName()); %>
			to...</h2>
	...
	<div class="w3-container w3-aqua">
		...
		<input type="text" id="productName" name="productName" value="<%= newDonation.getProduct().getProdType() %>"
			   readonly>
